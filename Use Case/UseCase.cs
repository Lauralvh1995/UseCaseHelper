    ...
    class UseCase 
    {
        ...
        public void Draw(Graphics g)
        {
           switch (selection)
            ...
            g.FillEllipse(new SolidBrush(Color.White), location.X - (size.Width / 2) - 20, location.Y - (size.Height / 2) - 10, size.Width + 40, size.Height + 20);
            g.DrawEllipse(pen, location.X - (size.Width / 2) - 20, location.Y - (size.Height / 2) - 10, size.Width + 40, size.Height + 20);
